...
public class HomePageTest extends BaseTest {
	...
	public void verifyDepartureDropdownContainsExpectedCities() {
		HomePage homePage = new HomePage(driver);
		Assert.assertTrue(homePage.getDepartureCities().contains("Boston"),
				"Boston City is Not Present in Departure Dropdown");
		Assert.assertFalse(homePage.getDepartureCities().contains("London"),
				"London City should not be Present in Departure Dropdown");
	}

	@Test
	public void verifyDestinationDropdownContainsExpectedCities() {
		HomePage homePage = new HomePage(driver);
		Assert.assertTrue(homePage.getDestinationCities().contains("London"),
				"London City is Not Present in Destination Dropdown");
	}
	...
	public void verifyUserCanSearchFlightSuccessfully() {
		...
		Assert.assertTrue(driver.getCurrentUrl().contains("reserve.php"),
				"User is not navigated to Flight Selection Page");
	}
}
