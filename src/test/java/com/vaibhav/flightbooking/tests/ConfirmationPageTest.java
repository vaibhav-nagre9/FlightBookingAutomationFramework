...
public class ConfirmationPageTest extends BaseTest {
	...
	public void verifyUserCanBookFlightSuccessfully() {
		...
		Assert.assertTrue(thankYouText.contains("Thank you"), "Thank you message is not displayed correctly");
		...
		Assert.assertEquals(bookingStatus, "PendingCapture", "Booking status mismatch");
