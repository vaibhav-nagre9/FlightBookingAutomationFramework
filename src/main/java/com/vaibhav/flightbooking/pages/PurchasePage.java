...
public class PurchasePage {
	...
	public void fillPaymentDetails(String cardTypeDropdown, String cardNumber, String cardMonth, String cardYear,
	...
	public String getCreditCardNumber() {
		return driver.findElement(creditCardNumber).getAttribute("value");
	}

	public String getCreditCardMonth() {
		return driver.findElement(creditCardMonth).getAttribute("value");
	}

	public String getCreditCardYear() {
		return driver.findElement(creditCardYear).getAttribute("value");
	}

	public String getCardHolderName() {
		return driver.findElement(nameOnCard).getAttribute("value");
	}
